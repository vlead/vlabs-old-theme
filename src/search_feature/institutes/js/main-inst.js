...
var filterLabsByPhase = function(labs) {
  ...
  var buildLabsDisplayList = function(labs) {
	...
	// return lab_name;
      return '<div class="col-md-10 lab-list-row-div" id='+ lab_id + '> <div style="margin-top: 20px; " class=" col-md-6" style="cursor:pointer; padding: 0px !important;"><a  href="' + hosted_url + '" ><div><p id="' + hosted_url + '"  >'+ lab_name +'</p></a></div> </div> <div class="col-md-3"><p class="text-normal-gray-small">'+ institute_name +' </p></div><div class="col-md-3"><div class="col-md-12 lab-list-row-col-2" ><a class="nounderline"><img style="width: 15px; vertical-align: text-bottom;" src="./images/syllabus.png">References Books</img></a><br><a class="nounderline"><img style="width: 15px;   vertical-align: text-bottom; margin-left:2px;" src="./images/refbook.png">Syllabus Mapping</img></a></br><a><img style="width: 15px; vertical-align: text-bottom;" src="./images/chat.png" >Lecture</img></a> </div></div></div>';
    });
