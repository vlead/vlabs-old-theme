...
var filterLabsByPhase = function(labs) {
  ...
  var buildLabsDisplayList = function(labs) {
	...
	// return lab_name;
      return '<div class="col-md-12 lab-list-row-div" id='+ lab_id + '> <div style="margin-top: 20px; " class=" col-md-6" style="cursor:pointer; padding: 0px !important;"><a  href="' + hosted_url + '" ><div><p id="' + hosted_url + '"  >'+ lab_name +'</p></a></div> </div> <div class="col-md-3" ><p class="text-normal-gray-small" style="margin-top:20px;">'+ institute_name +' </p></div><div class="col-md-3"><div class="col-md-12 lab-list-row-col-2" ><img style="width: 15px; vertical-align: text-bottom;" src="./images/syllabus.png"><a class="nounderline" style="margin-left:8px;">References Books</img></a><br><img style="width: 15px;   vertical-align: text-bottom;" src="./images/refbook.png"><a class="nounderline" style="margin-left:8px;">Syllabus Mapping</img></a></br><img style="width: 15px; vertical-align: text-bottom;" src="./images/chat.png" ><a class="nounderline" style="margin-left:8px;">Lecture</img></a> </div></div></div>';
    });
